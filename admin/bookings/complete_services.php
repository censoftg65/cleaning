...
$collection_booking = $objBooking->getCompleteBooking();
          ...
          <table class="table table-bordered table-striped table-hover" id="dTable">
            ...
            <tbody>
              ...
              foreach ($collection_booking as $booked) {
                $class = ($booked['txtAction'] == 'cancel') ? "warning" : "";
              ?>
              <tr class="<?= $class?>">
                ...
                <td>
                  <center>
                      ...
                      &nbsp;
                      <?php if ($booked['rateStatus'] == '') { ?>
                      <button type="button" title="Rating Not Available" disabled="">
                          <i class="fa fa-eye" aria-hidden="true"></i>
                      </button>
                      <?php } else { ?>
                      <a title="Delete">
                          <button type="button" title="View Rating" id="viewRating" value="<?= $booked['rateId']?>">
                              <i class="fa fa-eye" aria-hidden="true"></i>
                          </button>
                      </a>
                      <?php } ?>
