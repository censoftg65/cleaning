...
$arr_book['hidServiceAmt'] 		= $db->getParam('hidServiceAmt');
$arr_book['txtExtraServiceAmt'] = $db->getParam('txtExtraServiceAmt');

$tot_amt = $arr_book['hidServiceAmt'] + $arr_book['txtExtraServiceAmt'] + $arr_book['txtServiceTip'];
...
echo '<div class="col-sm-12">';
	echo '<div class="form-group">';
		...
		echo '<div class="col-sm-6">';	
			...
			echo '<div class="col-sm-6">$ '.$arr_book['hidServiceAmt'].'</div>';
		echo '</div>';
		echo '<div class="col-sm-6">';	
